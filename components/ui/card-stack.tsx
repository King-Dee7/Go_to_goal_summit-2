              ...
              return (
                <motion.div
                  ...
                  className={cn(
                    ...
                    isActive
                      ? "cursor-grab active:cursor-grabbing border border-white/80"
          ...
          {items.map((it, idx) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "rounded-full bg-black md:bg-white transition-all duration-300",
                  on
                    ? "h-2.5 w-2.5 opacity-100"
                    : "h-2 w-2 opacity-30 hover:opacity-60",
                )}
    ...
    <div className="relative h-full w-full">
      ...
      {active && item.href && (
        <a
          ...
          className="absolute right-4 top-4 z-20 flex h-10 w-10 items-center justify-center rounded-full border border-white/40 text-white transition-all duration-300 hover:scale-110 hover:border-white hover:bg-white hover:text-black"
