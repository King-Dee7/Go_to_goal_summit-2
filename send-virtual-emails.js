...
async function sendVirtualEmails() {
  ...
  console.log("Found " + trueVirtuals.length + " remaining virtual attendees.");
  
  // Get exactly 52 to stay under the 100/day limit
  const batchToSend = trueVirtuals.slice(0, 52);
